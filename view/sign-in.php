...
<body>
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-color:#C592A4">
      <span ></span>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form action="index.php?action=login_execute" role="form" class="text-start" method="post">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="index.php?action=register" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                  <a href="index.php?action=home" class="text-primary text-gradient ">Back To Home</a>
                </form>
              </div>
            </div>
          </div>
  ...
  <script src="view/assets/js/material-dashboard.min.js?v=3.1.0"></script>
</body>
